...
public extension XNode {
    ...
    func content(proceeding direction: XSequentialDirection) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, while condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, until condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func content(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, while condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, until condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func immediateTexts(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, while condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, until condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func allTexts(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection,) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, while whileCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, until untilCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, while condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, until condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func children(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, while condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, until condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContent(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
...
public extension XContent {
    ...
    func adjacent(proceeding direction: XSequentialDirection) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, while condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, until condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacent(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, while condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, until condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentIncludingSelf(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, while whileCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XContent) -> Bool, until untilCondition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, while condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, until condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func allContentIncludingSelf(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XContent) -> Bool) -> XContentSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, while whileCondition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, until untilCondition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, while condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, until condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTexts(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, while whileCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, until untilCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, while condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, until condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblings(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, while whileCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, until untilCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, while condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, until condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblings(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
...
public extension XText {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, while whileCondition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XText) -> Bool, until untilCondition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, while condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, until condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
    ...
    func adjacentTextsIncludingSelf(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XText) -> Bool) -> XTextSequence {
        switch direction {
...
public extension XElement {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, while whileCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, until untilCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, while condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, until condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func siblingsIncludingSelf(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, while whileCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, _ condition: @escaping (XElement) -> Bool, until untilCondition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, while condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, until condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
    ...
    func closeSiblingsIncludingSelf(proceeding direction: XSequentialDirection, untilAndIncluding condition: @escaping (XElement) -> Bool) -> XElementSequence {
        switch direction {
