...
public extension XElement {
    ...
    func sibling(proceeding direction: XSequentialDirection) -> XElement? {
        switch direction {
        case .previous:
...
public extension XDocumentSource {
    ...
    /// The root property will be an empty representation of the root element.
